...
// Index page
controllers.index = function(data, callback) {
	if (data.method == 'get') {
		...
		views.get('index', viewsData, function(err, str) {
			if (!err && str) {
				views.render(str, viewsData, function(err, str) {
					if (!err && str) {
...
// Public assets
controllers.public = function(data, callback) {
	if (data.method == 'get') {
...
// Create account
controllers.accountCreate = function(data, callback) {
	if (data.method == 'get') {
		...
		// Read in a template as a string
		views.get('accountCreate', viewsData, function(err, str) {
			if (!err && str) {
				views.render(str, viewsData, function(err, str) {
					if (!err && str) {
						callback(200, str, 'html');
